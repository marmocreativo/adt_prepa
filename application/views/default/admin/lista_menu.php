									...
									foreach($elementos as $nivel){
										...
										echo "<li class='list-group-item' id='elementos_".$nivel->ID_MENU."'>";
											echo '<div class="mb-3">'.$nivel->MENU_ETIQUETA;
												...
												echo '<button data-enlace="'.base_url('admin/menu_borrar?id='.$nivel->ID_MENU.'&grupo='.$grupo).'" class="btn btn-sm btn-outline-danger ml-2 borrar_entrada" title="Eliminar"> <span class="fa fa-trash"></span> </button></div>';
												...
												echo '
													...
													<input type="hidden" name="MenuGrupo" value="'.$grupo.'">
														<div class="form-group">
															<label for="Etiqueta">Etiqueta</label>
