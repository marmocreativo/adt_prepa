<ul class="list-unstyled components">
  ...
  <li>
      ...
      <ul class="collapse list-unstyled" id="homeSubmenuEquipos">
        <?php foreach($tipos_publicaciones as $tipo_publicacion){ ?>
          <li> <a href="<?php echo base_url('index.php/admin/equipos?tipo='.$tipo_publicacion->TIPO_NOMBRE); ?>"><i class="fa fa-users"></i> <?php echo $tipo_publicacion->TIPO_NOMBRE_PLURAL; ?></a> </li>
          <?php } ?>
      </ul>
  </li>
  ...
  <li>
      ...
      <ul class="collapse list-unstyled" id="homeSubmenuProyectos">
        <?php foreach($tipos_publicaciones as $tipo_publicacion){ ?>
          <li> <a href="<?php echo base_url('index.php/admin/proyectos?tipo='.$tipo_publicacion->TIPO_NOMBRE); ?>"><i class="fa fa-users"></i> <?php echo $tipo_publicacion->TIPO_NOMBRE_PLURAL; ?></a> </li>
          <?php } ?>
      </ul>
  </li>
  ...
  <li>
      ...
      <ul class="collapse list-unstyled" id="homeSubmenuTareas">
        <?php foreach($tipos_publicaciones as $tipo_publicacion){ ?>
          <li> <a href="<?php echo base_url('index.php/admin/tareas?tipo='.$tipo_publicacion->TIPO_NOMBRE); ?>"><i class="fa fa-check"></i> <?php echo $tipo_publicacion->TIPO_NOMBRE_PLURAL; ?></a> </li>
          <?php } ?>
      </ul>
  </li>
  ...
  <li>
      ...
      <ul class="collapse list-unstyled" id="homeSubmenuUsuarios">
        <?php foreach($tipos_publicaciones as $tipo_publicacion){ ?>
          <li> <a href="<?php echo base_url('index.php/admin/usuarios?tipo='.$tipo_publicacion->TIPO_NOMBRE); ?>"><i class="fa fa-user"></i> <?php echo $tipo_publicacion->TIPO_NOMBRE_PLURAL; ?></a> </li>
          <?php } ?>
      </ul>
  </li>
  <li><a href="<?php echo base_url('index.php/admin/opciones'); ?>"><i class="fa fa-sliders-h"></i> Configuraciones</a></li>
  <li><a href="<?php echo base_url('index.php/admin/tipos?tipo=usuarios'); ?>"><i class="fa fa-sitemap"></i> Tipos</a></li>
  <li><a href="<?php echo base_url('index.php/admin/base_de_datos'); ?>"><i class="fa fa-database"></i> Base de datos</a></li>
</ul>
