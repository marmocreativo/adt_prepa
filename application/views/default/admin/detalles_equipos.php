	...
	<div class="row mb-4">
		<div class="col">
			<ul class="nav nav-tabs nav-fill">
			  <li class="nav-item">
			    <a class="nav-link active" href="<?php echo base_url('index.php/admin/equipos/detalles?id='.$equipo['ID_EQUIPO']); ?>"> <i class="fa fa-users"></i> </a>
			  </li>
			  <li class="nav-item">
			    <a class="nav-link" href="<?php echo base_url('index.php/admin/equipos/proyectos?id='.$equipo['ID_EQUIPO']); ?>"> <i class="fas fa-project-diagram"></i> </a>
			  </li>
			</ul>
			<div class="bg-white p-2 py-4">
				...
				<?php foreach ($usuarios as $usuario) { ?>
					<div class="col-12 col-sm-6 col-md-3 mb-3">
						<a href="<?php echo base_url('index.php/admin/usuarios/detalles?id='.$usuario->ID_USUARIO); ?>">
