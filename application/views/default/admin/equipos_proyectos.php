	...
	<div class="row">
		...
		<div class="col-12 col-md-9">
			...
			<ul class="nav nav-tabs nav-fill">
			  <li class="nav-item">
			    <a class="nav-link" href="<?php echo base_url('index.php/admin/proyectos/detalles?id='.$proyecto['ID_PROYECTO']); ?>"><i class="fas fa-tasks"></i></a>
			  </li>
				<li class="nav-item">
			    <a class="nav-link active" href="<?php echo base_url('index.php/admin/proyectos/equipos?id='.$proyecto['ID_PROYECTO']); ?>"> <i class="fa fa-users"></i> </a>
			  </li>
			</ul>
