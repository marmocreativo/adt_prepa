	...
	<div class="encabezado_proyecto p-2">
		<div class="row">
			<div class="col-12 mb-3">
				...
				<table class="table">
					<tr>
						<td class="text-center"> <i class="fa fa-check-square"></i> <?php echo $proyecto['ESTADO']; ?></td>
						<td class="text-center"> <i class="fa fa-calendar"></i> <?php echo $proyecto['FECHA_ENTREGA']; ?></td>
					</tr>
				</table>
			</div>
			<div class="col-5">
