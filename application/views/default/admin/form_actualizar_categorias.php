						...
						<div class="kt-section__content">
							<div class="row">
								<div class="col-12 col-md-8">
									...
									<div class="card mt-3">
										<div class="card-body">
											<h6> <i class="fa fa-cogs"></i> Meta Datos</h6>
											...
											-->
											<div class="form-group">
												<label for="Meta[ordenar_por]">Ordenar Por</label>
												<select class="form-control" name="Meta[ordenar_por]">
													<option value="PUBLICACION_TITULO ASC" <?php if(isset($meta_datos['ordenar_por'])&&$meta_datos['ordenar_por']=='PUBLICACION_TITULO ASC'){ echo 'selected'; } ?> >Alfabético A-Z</option>
													<option value="PUBLICACION_TITULO DESC" <?php if(isset($meta_datos['ordenar_por'])&&$meta_datos['ordenar_por']=='PUBLICACION_TITULO DESC'){ echo 'selected'; } ?> >Alfabético Z-A</option>
													<option value="FECHA_PUBLICACION DESC" <?php if(isset($meta_datos['ordenar_por'])&&$meta_datos['ordenar_por']=='FECHA_PUBLICACION DESC'){ echo 'selected'; } ?> >Fecha de Publicación (Más nuevos primero)</option>
													<option value="FECHA_PUBLICACION ASC" <?php if(isset($meta_datos['ordenar_por'])&&$meta_datos['ordenar_por']=='FECHA_PUBLICACION ASC'){ echo 'selected'; } ?> >Fecha de Publicación (Más antiguos primero)</option>
													<option value="ORDEN ASC" <?php if(isset($meta_datos['ordenar_por'])&&$meta_datos['ordenar_por']=='ORDEN ASC'){ echo 'selected'; } ?> >Orden Personalizado</option>
												</select>
											</div>
											<div class="form-group">
												<label for="Meta[columnas]">Columnas por fila</label>
												<select class="form-control" name="Meta[columnas]">
													<option value="col-sm-6" <?php if(isset($meta_datos['columnas'])&&$meta_datos['columnas']=='col-sm-6'){ echo 'selected'; } ?>>2</option>
													<option value="col-sm-4" <?php if(isset($meta_datos['columnas'])&&$meta_datos['columnas']=='col-sm-4'){ echo 'selected'; } ?>>3</option>
													<option value="col-sm-3" <?php if(isset($meta_datos['columnas'])&&$meta_datos['columnas']=='col-sm-3'){ echo 'selected'; } ?>>4</option>
												</select>
											</div>
										</div>
									</div>
