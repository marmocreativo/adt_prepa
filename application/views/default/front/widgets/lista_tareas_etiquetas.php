...
<div class="etiqueta_contenedor" style="margin-bottom: 30px;">
    <div class="m-2"> <h4 class="border border-info text-info p-2 d-inline"><i class="fa fa-tag"></i> Generales</h4></div>
    <div>
...
<?php foreach($etiquetas as $etiqueta){ ?>
    ...
    ?>
<div class="etiqueta_contenedor" style="margin-bottom: 30px;">
<div class="m-2"> <h4 class="border border-info text-info p-2 d-inline"><i class="fa fa-tag"></i> <?php echo $etiqueta->ETIQUETA ?></h4></div>
    <div>
    <ul class="list-unstyled lista_tareas <?php echo $modo; ?>">
        <?php $fecha = ''; foreach($tareas as $tarea){ ?>
        <?php if($fecha != $tarea->FECHA_FINAL){ $fecha = $tarea->FECHA_FINAL; ?>
