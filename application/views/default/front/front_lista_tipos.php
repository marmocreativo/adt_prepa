...
<div class="jumbotron jumbotron-fluid mb-3 pb-4 bg-primary overlay overlay-black position-relative" style="background-size:cover; background-position: center; background-image:url(<?php echo base_url('assets/img/main_bg.jpg'); ?>">
	<div class="container text-white h-100 tofront">
		<div class="row align-items-center justify-content-center text-center">
			<div class="col-md-10">
				<h1 class="text-primary">  Categorias <?php echo $categoria['TIPO_NOMBRE_PLURAL']; ?></h1>
			</div>
		</div>
	</div>
</div>
...
<div class="contenido-principal">
  <div class="container pt-5 pb-5">
		<div class="row">
			<?php $categorias_hijas = $this->GeneralModel->lista('categorias','',['TIPO'=>$categoria['TIPO_NOMBRE'],'CATEGORIA_PADRE'=>'0','ESTADO'=>'activo','VISIBLE'=>'visible'],'ORDEN ASC','',''); ?>
			<?php if(!empty($categorias_hijas)){ ?>
			<div class="col-12">
				<div class="text-center py-3">
		      <h2 class="h2 text-primary"><?php echo $categoria['TIPO_NOMBRE_PLURAL']; ?></h2>
		    </div>
			</div>
