<a href="<?php echo base_url('areas/crear?tipo='.$tipo."&consulta=".base64_encode(json_encode($consulta))); ?>" class="btn btn-success btn-circulo-flotante"> <i class="fa fa-plus"></i></a>
<div class="lista_areas">
	<div class="row mt-4">
		<?php foreach($areas as $area){ ?>
		<div class="col-12 col-md-4">
			<div class="proyecto p-0">
				<a href="<?php echo base_url('areas/detalles?id='.$area->ID_AREA); ?>">
	...
	<div class="row justify-content-md-center">
		<div class="col-2">
			<a href="<?php echo base_url('areas?'.$consulta_anterior); ?>" class="btn btn-outline-primary btn-block <?php if($pagina == 1){ echo 'disabled'; } ?>"> <i class="fa fa-chevron-left"></i> Anterior</a>
		</div>
		<div class="col-2">
			<form class="enviar_enter" action="<?php echo base_url('areas'); ?>" method="get">
		...
		<div class="col-2">
			<a href="<?php echo base_url('areas?'.$consulta_siguiente); ?>" class="btn btn-outline-primary btn-block <?php if($pagina == $cantidad_paginas){ echo 'disabled'; } ?>"> Siguiente <i class="fa fa-chevron-right"></i> </a>
		</div>
	</div>
	<?php } ?>
</div>
