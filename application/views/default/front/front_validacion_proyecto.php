    ...
    <?php if(isset($_GET['tarea'])&&!empty($_GET['tarea'])){ ?>
        ...
        <?php if(!empty($verificar_respuestas)){ ?>
            <div class="card card-body seccion mb-3">
                ...
                ?>
                <a href="<?php echo base_url('index.php/tareas/detalles?id='.$detalles_tarea['ID_TAREA']); ?>"><h4><small>Tarea:</small><br><?php echo $detalles_tarea['TAREA_TITULO']; ?> <i class="fas fa-link"></i></h4></a>
            </div>
            <div class="card card-body seccion mb-3 lista-revision">
