...
class Admin_Publicaciones extends CI_Controller {
	...
	public function index()
	{
		...
		$parametros_and['meta_datos.TIPO_OBJETO']='publicacion';
		...
		// Join con categoria
		if(!empty($categoria)){
			$tablas_join['categorias_objetos'] = 'categorias_objetos.ID_OBJETO = meta_datos.ID_OBJETO';
		...
		if($this->form_validation->run())
    {
      ...
      $this->GeneralModel->actualizar('publicaciones',['ID_PUBLICACION'=>$this->input->post('Identificador')],$parametros);
			...
			$this->GeneralModel->borrar('meta_datos',['ID_OBJETO'=>$this->input->post('Identificador'),'TIPO_OBJETO'=>'publicacion']);
			// Meta Datos
			if(!empty($_POST['Meta'])){
	...
	public function borrar_permanente()
	{
      ...
      {
					// Borro metadatos
					$this->GeneralModel->borrar('meta_datos',['ID_OBJETO'=>$publicacion['ID_PUBLICACION'],'TIPO_OBJETO'=>'publicacion']);
					// Borro categorias
