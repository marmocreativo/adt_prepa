...
class Admin_Categorias extends CI_Controller {
	...
	public function index()
	{
		...
		$parametros_and['meta_datos.TIPO_OBJETO']='categoria';

		$tablas_join = array(
			'meta_datos' => 'meta_datos.ID_OBJETO = categorias.ID_CATEGORIA'
		);
		...
		if($this->form_validation->run())
    {
      ...
      $this->GeneralModel->actualizar('categorias',['ID_CATEGORIA'=>$this->input->post('Identificador')],$parametros);
			...
			$this->GeneralModel->borrar('meta_datos',['ID_OBJETO'=>$this->input->post('Identificador'),'TIPO_OBJETO'=>'categoria']);
			// Meta Datos
			if(!empty($_POST['Meta'])){
			...
			$this->data['meta'] = $this->GeneralModel->lista('meta_datos','',['ID_OBJETO'=>$_GET['id'],'TIPO_OBJETO'=>'categoria'],'','','');
