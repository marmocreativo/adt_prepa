...
class Front_Equipos extends CI_Controller {
  ...
  parent::__construct();
	...
	public function index()
	{
		...
		$tablas_join = array();
		if($todo=='no'){
			$tablas_join['equipos_usuarios'] = 'equipos_usuarios.ID_EQUIPO = equipos.ID_EQUIPO';
			$parametros_and['equipos_usuarios.ID_USUARIO'] = $_SESSION['usuario']['id'];
		}
		...
		$this->load->view($this->data['op']['plantilla'].$this->data['dispositivo'].'/front/front_lista_equipos',$this->data);
		...
		if($this->form_validation->run())
    {
      ...
      $this->GeneralModel->actualizar('equipos',['ID_EQUIPO'=>$this->input->post('Identificador')],$parametros);
			...
			// Cargo Vistas
			$this->load->view($this->data['op']['plantilla'].$this->data['dispositivo'].'/front/headers/header_principal',$this->data);
			$this->load->view($this->data['op']['plantilla'].$this->data['dispositivo'].'/front/front_form_actualizar_equipos',$this->data);
			$this->load->view($this->data['op']['plantilla'].$this->data['dispositivo'].'/front/footers/footer_principal',$this->data);
		}
	...
	public function detalles(){
		...
		$this->data['tipo'] = $this->data['equipo']['TIPO'];
		// Open Tags
		$this->data['titulo']  = $this->data['equipo']['EQUIPO_NOMBRE'];
		$this->data['descripcion']  = $this->data['equipo']['EQUIPO_DESCRIPCION'];
		$this->data['imagen']  = base_url('contenido/img/equipos/'.$this->data['equipo']['IMAGEN']);
		...
		// Cargo Vistas
		$this->load->view($this->data['op']['plantilla'].$this->data['dispositivo'].'/front/headers/header_principal',$this->data);
		$this->load->view($this->data['op']['plantilla'].$this->data['dispositivo'].'/front/front_detalles_equipo',$this->data);
		$this->load->view($this->data['op']['plantilla'].$this->data['dispositivo'].'/front/footers/footer_principal',$this->data);
	}
