...
<div class="jumbotron jumbotron-fluid mb-3 pb-4 bg-primary overlay overlay-black position-relative" style="background-size:cover; background-position: center; background-image:url(<?php echo base_url('assets/img/main_bg.jpg'); ?>">
	<div class="container text-white h-100 tofront">
		<div class="row align-items-center justify-content-center text-center">
			<div class="col-md-10">
				<h1 class="text-primary"> <i class="fa fa-cogs"></i>  Sitio en mantenimiento</h1>
			</div>
		</div>
	</div>
</div>
  ...
  <div class="container pt-5 pb-5">
  	<div class="row justify-content-center">
  		<div class="col-md-8">
  			...
  			<h3>  Nos encontramos trabajando para darte la mejor experiencia posible, por favor vuelve pronto.</h3>
  			</article>
  		</div>
  	</div>
  </div>
