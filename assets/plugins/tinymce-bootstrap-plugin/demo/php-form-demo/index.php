...
<head>
    ...
    <title>TinyMce Bootstrap Plugin for Bootstrap 4 - PHP Form Demo</title>
...
<body class="d-flex flex-column justify-content-between" style="min-height: 100vh">
    ...
    <?php if (!isset($_POST['html-content'])) { ?>
        ...
        <div class="container pt-4">
            <h1 class="text-secondary font-weight-light text-center mb-4">TinyMce Bootstrap Plugin for Bootstrap 4<br><small>PHP Form Demo</small></h1>
        ...
        =                Output                 =
        ======================================-->
            <h1 class="text-secondary font-weight-light text-center my-4">TinyMce Bootstrap Plugin for Bootstrap 4<br><small>Posted Bootstrap 4 HTML</small></h1>
